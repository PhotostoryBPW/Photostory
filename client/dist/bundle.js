...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function renderView() {
      ...
      if (view === 'feed') {
        return _react2.default.createElement(_Feed2.default, { handleClick: function handleClick() {
            return _this3.changeView(view);
          }, data: this.state.data, view: this.state.view });
      }
      //  else if (view === 'admin') {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        !!this.state.posts.length ? this.state.posts.map(function (post) {
          return _react2.default.createElement(Post, { post: post });
        }) : _react2.default.createElement(
          'div',
          null,
          'No posts to display.'
...
*/
var ba=__webpack_require__(2),m=__webpack_require__(14),A=__webpack_require__(5),C=__webpack_require__(3),ea=__webpack_require__(16),fa=__webpack_require__(17),ha=__webpack_require__(15),ja=__webpack_require__(4);
...
var m=__webpack_require__(5),n=__webpack_require__(4),p=__webpack_require__(3),q="function"===typeof Symbol&&Symbol["for"],r=q?Symbol["for"]("react.element"):60103,t=q?Symbol["for"]("react.portal"):60106,u=q?Symbol["for"]("react.fragment"):60107,v=q?Symbol["for"]("react.strict_mode"):60108,w=q?Symbol["for"]("react.provider"):60109,x=q?Symbol["for"]("react.context"):60110,y=q?Symbol["for"]("react.async_mode"):60111,z=q?Symbol["for"]("react.forward_ref"):60112,A="function"===
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement('input', { type: 'text', name: 'name', value: this.state.username, onChange: this.handleUsernameChange })
          )
        ),
        _react2.default.createElement(
          'h2',
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'label',
            { style: { marginRight: '5px' } },
            _react2.default.createElement('input', { type: 'password', name: 'name', value: this.state.password, onChange: this.handlePasswordChange })
          ),
          _react2.default.createElement(
            'button',
            { type: 'button', onClick: this.handleLogin, style: { display: 'block', marginTop: '10px', marginLeft: '50px' } },
            'Login'
          )
        )
      );
